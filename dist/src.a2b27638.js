...
function getMousePos(e) {
  ...
  if (e.clientX - rect.left - User.width / 2 > 0 && e.clientX - rect.left - User.width / 2 < canvas.width - User.width) {
...
function collision(ball, player) {
  ...
  return player.top < ball.bottom && player.left < ball.right && player.right > ball.left && player.bottom > ball.top;
}
...
function update() {
  ...
  var player = Ball.y + Ball.radius < canvas.width / 2 ? Cpu : User;
